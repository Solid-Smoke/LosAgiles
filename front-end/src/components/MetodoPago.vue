<template>
  <div class="container mt-5">
    ...
    <b-modal v-model="showFileErrorModal" title="Error de Archivo" hide-footer centered>
      <p class="my-2">El archivo seleccionado debe estar en formato PNG.</p>
      <b-button variant="danger" @click="showFileErrorModal = false">Cerrar</b-button>
    </b-modal>
